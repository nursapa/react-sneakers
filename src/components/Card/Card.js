    ...
    <div className={styles.card}>
      {isLoading ? (
        ...
        >
          ...
          <rect x="5" y="143" rx="3" ry="3" width="150" height="15" />
          <rect x="5" y="162" rx="3" ry="3" width="93" height="15" />
          <rect x="120" y="191" rx="8" ry="8" width="32" height="32" />
          <rect x="5" y="199" rx="8" ry="8" width="80" height="24" />
